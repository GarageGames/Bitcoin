...
namespace BCNet
{
    public class NodeConnection
    {
        ...
        public NodeConnection(Bitcoin owner, string nodeAddress, ushort port = 8333, uint protocolVersion = 0x00011171, uint networkID = 0xD9B4BEF9)
        {
            ...
            mThread.Name = owner.Name + "-" + mNodeAddress + ":" + mPort;
            mThread.Start();
        }
        ...
        public bool FetchingHeaders
        {
            get { return mFetchingHeaders; }
            set { mFetchingHeaders = value; }
        }
    }
}
